...
if(!empty($_POST['email2'])&& !empty($_POST['name2'])&& !empty($_POST['dob2'])&& !empty($_POST['contact2'])&& !empty($_POST['address2'])&& !empty($_POST['password2'])&& !empty($_POST['confirmpassword2']) )
  {
    ...
    if($b1!=true)       
    {
      ...
      $passwordconfirmError="password should be same as above";
    }
     ...
     $email2=$_POST['email2'];
      ...
      $password2=$_POST['password2'];
		...
		// database entry part
			...
			$query ="insert into userdetail (`email`,`name`,`dob`,`contact`,`address`,`password`) values('$email2','$name2','$dob','$contact2','$address2','$password2')";
...
<div class="container" style ="background-color:#f1f1f1; padding:50px;">										
			<form class="form-horizontal" action ="itsfinal.php" method="POST" id="formid">
        ...
        <label class="control-label col-sm-2">Contact No.*</label><input class="col-sm-10"  name="contact2" required placeholder ="Enter Contact No." maxlength="10" id="contactid" value="<?php echo  $contact2 ;?>"><span id="numbererrormsg"  style="visibility:hidden "><h6 class= text-danger>*enter proper number</h6></span>
  <span class="error">  <b class= "text-danger"><?php echo $contact2Err ;?></b></span><br>

        <label class="control-label col-sm-2">Address*</label><input class="col-sm-10" type="textarea" name="address2" required placeholder ="Enter Address" id="addressid" value="<?php echo  $address2;?>"><span id="addresserrormsg"  style="visibility:hidden "><h6 class= text-danger>*enter proper address</h6></span>
  <span class="error">  <b class= "text-danger"><?php echo $address2Err ;?></b></span><br>

        <label class="control-label col-sm-2">Password*</label><input class="col-sm-10" type="password" name="password2" id="passwordid" required placeholder ="Enter Password" value="<?php echo  $password2;?>"><span id="passworderrormsg"  style="visibility:hidden "><h6 class= text-danger>*enter proper password</h6></span>
  <span class="error">  <b class= "text-danger"><?php echo $password2Err ;?></b></span><br>
  ...
  <!--<span class="error">* <b class= "text-danger"><?php //echo $passwordconfirmError ;?></b></span><br>--><span id="confirmpassworderrormsg"  style="visibility:hidden "><h6 class= text-danger> *password doesn match</h6></span>
        ...
        <div class="col-12 text-center m-3">
          <button class="btn btn-outline-primary" id ="btnid"  >REGISTER</button>
        </div>
